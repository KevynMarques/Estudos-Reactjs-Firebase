...
background: rgb(116,32,162);
background: linear-gradient(90deg, rgba(116,32,162,0.9444152661064426) 11%, rgba(91,249,226,1) 50%, rgba(6,88,226,1) 75%, rgba(11,1,15,1) 100%);
height: 100vh;
`;
